 ...
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.mdsd.arduinoDSL.impl.ProgramImpl#getProgram <em>Program</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgramImpl extends MinimalEObjectImpl.Container implements Program
{
  ...
  {
    return ArduinoDSLPackage.Literals.PROGRAM;
  }
  ...
  public EList<EObject> getProgram()
  {
    if (program == null)
    {
      program = new EObjectContainmentEList<EObject>(EObject.class, this, ArduinoDSLPackage.PROGRAM__PROGRAM);
    }
    return program;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ArduinoDSLPackage.PROGRAM__PROGRAM:
